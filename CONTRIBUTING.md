...
def install
  ...
  system "cmake", "--build", "build" # rubocop:todo Layout/IndentationConsistency
  system "cmake", "--install", "build" # rubocop:todo Layout/IndentationConsistency
   prefix.install "build/install_manifest.txt" # rubocop:todo Layout/IndentationConsistency
end
```
